...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.devlabel = QtWidgets.QLabel(self.more_info)
        self.devlabel.setMinimumSize(QtCore.QSize(40, 40))
        self.devlabel.setMaximumSize(QtCore.QSize(40, 40))
        self.devlabel.setCursor(QtGui.QCursor(QtCore.Qt.PointingHandCursor))
        self.devlabel.setText("")
        self.devlabel.setPixmap(QtGui.QPixmap(":/images/images/web-development.png"))
        self.devlabel.setScaledContents(True)
        self.devlabel.setObjectName("devlabel")
        self.gridLayout.addWidget(self.devlabel, 0, 0, 1, 1)
        self.gitlabel = QtWidgets.QLabel(self.more_info)
        self.gitlabel.setMinimumSize(QtCore.QSize(40, 40))
        self.gitlabel.setMaximumSize(QtCore.QSize(40, 40))
        self.gitlabel.setCursor(QtGui.QCursor(QtCore.Qt.PointingHandCursor))
        self.gitlabel.setText("")
        self.gitlabel.setPixmap(QtGui.QPixmap(":/images/images/github.png"))
        self.gitlabel.setScaledContents(True)
        self.gitlabel.setOpenExternalLinks(True)
        self.gitlabel.setObjectName("gitlabel")
        self.gridLayout.addWidget(self.gitlabel, 1, 0, 1, 1)
        self.paypal_label = QtWidgets.QLabel(self.more_info)
        self.paypal_label.setMinimumSize(QtCore.QSize(40, 40))
        self.paypal_label.setMaximumSize(QtCore.QSize(40, 40))
        self.paypal_label.setCursor(QtGui.QCursor(QtCore.Qt.PointingHandCursor))
        self.paypal_label.setText("")
        self.paypal_label.setPixmap(QtGui.QPixmap(":/images/images/paypal.png"))
        self.paypal_label.setScaledContents(True)
        self.paypal_label.setOpenExternalLinks(True)
        self.paypal_label.setObjectName("paypal_label")
        self.gridLayout.addWidget(self.paypal_label, 2, 0, 1, 1)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.devlabel.setToolTip(
            _translate("MainWindow", "Click here to know more about the developer")
        )
        self.gitlabel.setToolTip(_translate("MainWindow", "Project GitHub Repository"))
        self.paypal_label.setToolTip(
            _translate("MainWindow", "Developer accepts Donation")
        )
